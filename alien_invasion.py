...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        #  and also make the scoreboard.
        self.stats = GameStats(self)
        self.sb = Scoreboard(self)
        # Make an instance of ship after the screen has been created
        self.ship = Ship(self)
        # Store the bullets in a Group
        self.bullets = pygame.sprite.Group()
        # Make an instance of the alien ship after the screen is created
    ...
    def _check_play_button(self, mouse_pos):
        """Start a new game after the player clicks the button."""
        ...
        if button_clicked and not self.stats.game_active:
            ...
            # Dispose of any remaining aliens and bullets.
            self.aliens.empty()
            self.bullets.empty()

            # Make a new fleet of aliens and center the ships_left
            self._create_fleet()
    ...
    def _check_fleet_edges(self):
        """Respond immediately if an alien has reached an edge."""
    ...
    def _ship_hit(self):
        ...
        if self.stats.ships_left > 0:
            # Lower ships_left, and update the scoreboard.
    ...
    def _check_aliens_bottom(self):
        ...
        for alien in self.aliens.sprites():
            if alien.rect.bottom >= screen_rect.bottom:
                # Treat this like the ship took a hit.
                self._ship_hit()
                break
